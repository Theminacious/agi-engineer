...
def generate_pr_body(fixed_count, issues_fixed, edr=None):
    """
    ...
    Args:
        ...
        edr: Optional EDR dict to append
    """
    body = f"""## 🤖 Automated Code Fixes
...
---
*Generated by AGI Engineer Bot 🤖*
"""
    
    # Append EDR if available
    if edr:
        # Import EDRGenerator to format EDR for PR
        from edr import EDRGenerator
        edr_gen = EDRGenerator()
        edr_markdown = edr_gen.format_for_pr(edr)
        body += "\n" + edr_markdown
